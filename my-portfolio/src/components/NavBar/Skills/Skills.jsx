  ...
  return (
   <section id="skills">
    ...
    <div className="skillBars">
        <div className="skillBar"><img src={UIUX} className="skillBarImg" alt="" />
        <div className="skillBarText">
         ...
         <div className="skillBar"><img src={WebDev} className="skillBarImg"alt="" />
        <div className="skillBarText">
         ...
         <div className="skillBar"><img src={AppDev} className="skillBarImg" alt="" />
        <div className="skillBarText">
